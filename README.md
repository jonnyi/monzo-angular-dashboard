...
app/                    --> all of the source files for the application
  ...
  authenticate/                --> the authenticate view template and logic
    authenticate.html            --> the partial template
    authenticate.js              --> the controller logic
    authenticate_test.js         --> tests of the controller
